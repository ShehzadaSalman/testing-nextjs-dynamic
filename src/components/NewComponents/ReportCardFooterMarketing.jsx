...
const ReportCardFooterMarketing = (props) => { 
...
const formSubmitReport = (event) => {
    ...
    var countryCode =  event.target.querySelector("#ReportForm-Marketing .iti__selected-dial-code").innerHTML;
    console.log(countryCode);
    event.target.querySelector("#ReportForm-Marketing  #countryCode").value = countryCode;
  ...
  $.ajax({
        type: "POST",
        url: finalurl,
        data: $("#ReportForm-Marketing").serialize(),
      ...
      <div className="row">
        ...
        <div className="col-md-6  d-flex align-items-center">
            ...
            <p className="text-direction">{props.caption}</p>
                <form onSubmit = {formSubmitReport} id = "ReportForm-Marketing">
               <div className="row">
                  
               <div className="col-md-6 mb-3 px-1">
               <input type = "hidden" className = "report-inputfield"  name = "reportname"  
               value = {props.reportfile} />  
                    <input
                      name="api_key"
                      id="api_key"
                      type="hidden"
               ...
               <input type = "email" className = "report-inputfield" name = "email"
                placeholder=
                {locale === 'ar' ? 'البريد الإلكتروني' : 'Email*'}  required />
...
export default ReportCardFooterMarketing;
