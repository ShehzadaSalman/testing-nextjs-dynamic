...
const ReportCardFooter = (props) => {
  ...
  useEffect(() => {
    ...
    const input = document.querySelector("#report-input-field");
    intlTelInput(input, {
  ...
  const formSubmitReport = (event) => {
    ...
    var countryCode =  event.target.querySelector("#ReportForm .iti__selected-dial-code").innerHTML;
    ...
    .report-footer-content p{
      ...
      .report-footer-content p{
       ...
       @media only screen and (max-width: 400px) {
         .report-footer-content h1{font-size: 2rem;}
      }
