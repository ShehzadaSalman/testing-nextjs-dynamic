...
export default class Headerthree extends Component {
  constructor(props) {
    super(props);
    this.state = {
      addClass: false,
          ...
          <div className={`row ${this.state.addClass ? 'drop-menu-top-bar' : ''}`}>
            <div className="col-3 logos">
              <Link href="/">
                <a>
                  <img 
                  loading="lazy"
                  style = {{  height: "45px"}} src={this.state.isMenu ? "/images/logo.png" : "/images/logo.png" } className="img-fluid dflts" alt="Tech Bay Solution" />
                  <img
                  loading="lazy"
            ...
            <div className="col-6 d-flex contctDetails xs-hidden">
              <div className="mg-language-selector">
                <ul>
                  <li>
                    <a href="tel:+97144257880" className = {this.state.isMenu ? 'white-color' : 'white-color'}>
                      <i className = {this.state.isMenu ? 'fa fa-phone white-color' : 'fa fa-phone white-color'}></i> +971 4 425 7880
                    </a>
                  </li>
                  <li>
                    <a href="mailto:info@techbay.co" className = {this.state.isMenu ? 'white-color' : 'white-color'}>
                      <i className={this.state.isMenu ? 'far fa-envelope white-color' : 'far fa-envelope white-color'}></i> info@techbay.co
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div className="col-3 justyfiedMenu">
              <div className="mg-header-content-wrapper d-flex align-items-center justify-content-md-end justify-content-end">
                ...
                <span className="mg-menu-hr" style = {{ color: "white" , backgroundColor: "white" }}></span>
