        ...
        <div className="full-banner">
          <div className="container text-center">
            <div className="mb-4 mb-md-5">
              <img src="/images/web/website-audit.png" alt="image" className="img-fluid" />
            </div>

            <h1 className="light">
              Free Website SEO audit in <br /> 90 seconds
         </h1>
        ...
        <div className="bottom-wave-bg content pt-5 pb-5">
          <div className="container">
            <p className="paragraph">
              Search Engines rely on many factors to rank a website. If you’re struggling to get more visitors to your site, the answer might just lie in this FREE report! If you want more search traffic, all you have to do is follow the website analysis report. It will point out all of the SEO errors you need to fix in order to increase your rankings.
            </p>
            <p className="paragraph">
              Get a complete list of errors that are hindering your site from achieving the top spot-on Google. This SEO audit report prioritizes each fix based on potential traffic impact and ease of implementation. Once you make changes, you can re-run the report and check to see if you did it correctly. Each audit contains great detail about your website and its SEO condition.
            </p>
            <p className="paragraph mb-5">
              Win more customers with a professional SEO Audit, written in simple language that inspires action. Enter an URL address and get a Free Website SEO Audit Report!
            </p>
          </div>
...
.formPopup-speed .formInner {
  ...
  left: 2%;
            ...
            .full-banner{
                ...
                height: calc(100vh);
                background-image: url('/images/web/new-pages/websiteauditbanner-small.png');
